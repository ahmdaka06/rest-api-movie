...
export class MovieService {
    ...
    static async getNowPlayingMovie(page: number): Promise<PaginatedResponse<Movie>> {
        try {
    ...
    static async getSearchMovie(request: SearchMovieRequest): Promise<PaginatedResponse<Movie>> {
        try {
            ...
            const url = `${process.env.TMDB_API_URL}/search/movie?query=${query}&page=${page}`;
            console.log(url);
            const options = {
                method: 'GET',
                headers: {
